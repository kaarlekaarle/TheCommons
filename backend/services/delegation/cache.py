...
class DelegationCache:
    ...
    async def batch_get_cached_chains(self, cache_keys: List[str]) -> Dict[str, Optional[List[Dict[str, Any]]]]:
    ...
    async def get_cache_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "cache_size": sum(len(k) for k in chain_keys + fast_path_keys) if chain_keys or fast_path_keys else 0,
            }
        except Exception:
            return {
                "chain_keys": 0,
