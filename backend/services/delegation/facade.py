"""Delegation service façade for backward compatibility.

This module provides the main DelegationService class that orchestrates
the refactored delegation services while maintaining backward compatibility.
"""
